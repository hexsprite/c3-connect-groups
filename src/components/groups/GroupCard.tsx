  ...
  return (
    <div className="c3-card">
      ...
      <div className="space-y-3">
        <h3 className="text-xl font-semibold" style={{ color: 'var(--c3-text-primary)' }}>
          {group.name}
        </h3>
        
        <p className="text-sm line-clamp-2" style={{ color: 'var(--c3-text-secondary)' }}>
          {group.description}
        </p>

        {/* Metadata */}
        <div className="space-y-2 text-sm" style={{ color: 'var(--c3-text-secondary)' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span>{group.meetingDay}s, {displayTime}</span>
          </div>
          
          <div className="flex items-center gap-2">
            <Users className="w-4 h-4" />
            <span>{group.groupType} • {group.currentMemberCount}/{group.capacity} members</span>
          </div>
        </div>
